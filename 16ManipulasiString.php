...
// > Sebenarnnya kita bisa menggunakan + (plus) untuk menambahkan string, namun jika kita coba tambahkan string dengan tipe data number, maka akan terjadi error. Oleh karena itu direkomendasikan menggunakan "." (dot) untuk menambahkan string dengan kata lain
...
// 4. Variabel Parsing
// > Khusus string menggunakan Doublue Quote atau Heredoc, kita bisa menggunakan karakter "$" untuk mengakses variabel
